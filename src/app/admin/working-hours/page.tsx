...
const departments = ["Sales", "Technical", "Support", "All Departments"];
...
const initialConfigs: WorkingConfig[] = [
  { dept: "Sales", startTime: "09:00", endTime: "18:00", lateThreshold: 15, overtime: true, breakType: "flexible", breakDuration: 60, breakStart: "13:00" },
  { dept: "Technical", startTime: "09:00", endTime: "18:00", lateThreshold: 15, overtime: true, breakType: "fixed", breakDuration: 45, breakStart: "13:00" },
  { dept: "Support", startTime: "09:00", endTime: "18:00", lateThreshold: 10, overtime: false, breakType: "flexible", breakDuration: 60, breakStart: "12:30" },
];
    ...
    <div className="p-6 space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">Define shifts, break policies, and overtime rules per department</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-100">
            <h3 className="font-bold text-gray-800 text-sm">Departments</h3>
          </div>
          <div className="divide-y divide-gray-50">
            {configs.map((c, i) => (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3.5 hover:bg-orange-50/40 transition-colors text-left ${
                  selected === i ? "bg-orange-50/60 border-r-2 border-orange-400" : ""
                }`}
              >
                <div className={`p-2 rounded-lg ${selected === i ? "bg-orange-100" : "bg-gray-100"}`}>
                  <Clock className={`h-4 w-4 ${selected === i ? "text-orange-500" : "text-gray-400"}`} />
                </div>
                <div>
                  <p className="text-sm font-semibold text-gray-800">{c.dept}</p>
        ...
        {/* Config form */}
        <div className="lg:col-span-3 bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-5">
          <h3 className="font-bold text-gray-800">{config.dept} — Working Hours Policy</h3>
          ...
          <div className="pt-4 border-t border-gray-100">
            <div className="bg-orange-50 border border-orange-100 rounded-xl p-4">
              ...
              <p className="text-sm text-gray-700">
                <strong>{config.dept}</strong>: Work {config.startTime}–{config.endTime} · 
